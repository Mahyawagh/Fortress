...
router.get('/employee', (req, res) => {
    const query = "SELECT id, name, email, password, status FROM employeeFortress";
...
router.put('/user_employee/toggleStatus/:userId/:currentStatus', (req, res) => {
    // console.log("hiii")
    const { userId, currentStatus } = req.params;
    const newStatus = currentStatus === 'Active' ? 'Inactive' : 'Active';
    const query = `UPDATE employeeFortress SET status = ? WHERE id = ?`;
...
router.post('/employee/add', (req, res) => {
    ...
    const query = `INSERT INTO employeeFortress (name, email, password, status) VALUES (?, ?, ?, 'Active')`;
...
router.delete('/employee/delete', (req, res) => {
    ...
    const query = `DELETE FROM employeeFortress WHERE name = ? OR email = ?`;
...
router.put('/employee/update', (req, res) => {
    ...
    const query = `UPDATE employeeFortress SET ${updateFields} WHERE name = ? OR email = ?`;
