...
function refreshGrid() {
    fetch('/OtherEnvironment/projectsHTML')
    .then(response => {
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
...
function searchProject() {
    ...
    fetch(`/OtherEnvironment/search?searchInput=${searchInput}`)
    .then(response => {
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
    ...
    .then(data => {
        const projectUrl = `/OtherEnvironment/display?refId=${data.refId}`;
...
function viewDocumentation(refId) {
    fetch(`/OtherEnvironment/display_documentation?refId=${refId}`)
      .then(response => {
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
      ...
      .then(data => {
        ...
        documentation.forEach(doc => {
          ...
          link.href = `/OtherEnvironment/get-documentation/${doc}`;
