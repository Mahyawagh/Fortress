...
function refreshGrid() {
    fetch('/OtherUrbanInfra/projectsHTML')
    .then(response => {
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
...
function searchProject() {
    ...
    fetch(`/OtherUrbanInfra/search?searchInput=${searchInput}`)
    .then(response => {
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
    ...
    .then(data => {
        const projectUrl = `/OtherUrbanInfra/display?refId=${data.refId}`;
...
function viewDocumentation(refId) {
    fetch(`/OtherUrbanInfra/display_documentation?refId=${refId}`)
      .then(response => {
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
      ...
      .then(data => {
        ...
        documentation.forEach(doc => {
          ...
          link.href = `/OtherUrbanInfra/get-documentation/${doc}`;
