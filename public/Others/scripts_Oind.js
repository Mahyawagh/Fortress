...
function refreshGrid() {
    fetch('/OtherIndustrial/projectsHTML')
    .then(response => {
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
...
function searchProject() {
    ...
    fetch(`/OtherIndustrial/search?searchInput=${searchInput}`)
    .then(response => {
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
    ...
    .then(data => {
        const projectUrl = `/OtherIndustrial/display?refId=${data.refId}`;
...
function viewDocumentation(refId) {
    fetch(`/OtherIndustrial/display_documentation?refId=${refId}`)
      .then(response => {
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
      ...
      .then(data => {
        ...
        documentation.forEach(doc => {
          ...
          link.href = `/OtherIndustrial/get-documentation/${doc}`;
