...
function refreshGrid() {
  fetch('/transportation/projectsHTML')
  .then(response => {
      if (!response.ok) {
          throw new Error('Network response was not ok');
      }
...
function searchProject() {
  ...
  fetch(`/transportation/search?searchInput=${searchInput}`)
  .then(response => {
      if (!response.ok) {
          throw new Error('Network response was not ok');
      }
  ...
  .then(data => {
      const projectUrl = `/transportation/display?projectId=${data.projectId}`;
...
function viewPhotographs(projectId) {
  fetch(`/transportation/display_project?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
...
function viewDocumentation(projectId) {
  fetch(`/transportation/display_documentation?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      documentation.forEach(doc => {
        ...
        link.href = `/transportation/get-documentation/${doc}`;
...
function viewReport(projectId) {
  fetch(`/transportation/display_report?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      report.forEach(report => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/transportation/get-report/${report}`;
...
function viewPresentation(projectId) {
  fetch(`/transportation/display_presentation?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      presentation.forEach(presentation => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/transportation/get-presentation/${presentation}`;
...
function viewOther(projectId) {
  fetch(`/transportation/display_other?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      other.forEach(other => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/transportation/get-other/${other}`;
...
function deleteProject() {
  ...
  fetch(`/transportation/delete?searchInput=${searchInput}`)
      .then(response => {
          if (!response.ok) {
              throw new Error('Network response was not ok');
          }
...
document.getElementById("updateForm").addEventListener("submit", function(event) {
  ...
  .then(data => {
    ...
    closeUpdateForm(); // Close the form after successful deletion
            refreshGrid();
