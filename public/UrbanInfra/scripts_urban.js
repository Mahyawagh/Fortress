...
function searchProject() {
  ...
  fetch(`/urbaninfra/search?searchInput=${searchInput}`)
  .then(response => {
      if (!response.ok) {
          throw new Error('Network response was not ok');
      }
  ...
  .then(data => {
      const projectUrl = `/urbaninfra/display?projectId=${data.projectId}`;
...
function viewPhotographs(projectId) {
  fetch(`/urbaninfra/display_project?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
...
function viewDocumentation(projectId) {
  fetch(`/urbaninfra/display_documentation?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      documentation.forEach(doc => {
        ...
        link.href = `/urbaninfra/get-documentation/${doc}`;
...
function viewReport(projectId) {
  fetch(`/urbaninfra/display_report?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      report.forEach(report => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/urbaninfra/get-report/${report}`;
...
function viewPresentation(projectId) {
  fetch(`/urbaninfra/display_presentation?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      presentation.forEach(presentation => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/urbaninfra/get-presentation/${presentation}`;
...
function viewOther(projectId) {
  fetch(`/urbaninfra/display_other?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      other.forEach(other => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/urbaninfra/get-other/${other}`;
...
function deleteProject() {
  ...
  fetch(`/urbaninfra/delete?searchInput=${searchInput}`)
      .then(response => {
          if (!response.ok) {
              throw new Error('Network response was not ok');
          }
