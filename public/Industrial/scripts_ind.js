...
function searchProject() {
  ...
  fetch(`/industrial/search?searchInput=${searchInput}`)
  .then(response => {
      if (!response.ok) {
          throw new Error('Network response was not ok');
      }
  ...
  .then(data => {
      const projectUrl = `/industrial/display?projectId=${data.projectId}`;
...
function viewPhotographs(projectId) {
  fetch(`/industrial/display_project?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
...
function viewDocumentation(projectId) {
  fetch(`/industrial/display_documentation?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      documentation.forEach(doc => {
        ...
        link.href = `/industrial/get-documentation/${doc}`;
...
function viewReport(projectId) {
  fetch(`/industrial/display_report?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      report.forEach(report => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/industrial/get-report/${report}`;
...
function viewPresentation(projectId) {
  fetch(`/industrial/display_presentation?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      presentation.forEach(presentation => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/industrial/get-presentation/${presentation}`;
...
function viewOther(projectId) {
  fetch(`/industrial/display_other?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      other.forEach(other => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/industrial/get-other/${other}`;
...
function deleteProject() {
  ...
  fetch(`/industrial/delete?searchInput=${searchInput}`)
      .then(response => {
          if (!response.ok) {
              throw new Error('Network response was not ok');
          }
