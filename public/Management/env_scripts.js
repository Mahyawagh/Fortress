...
//       fetch('/managementenvironment/project_list')
//       .then(response => {
//           if (!response.ok) {
...
//     fetch(`/managementenvironment/search?searchInput=${searchInput}`)
//     .then(response => {
//         if (!response.ok) {
//             throw new Error('Network response was not ok');
//         }
...
//     // Check if the searchResultsContainer exists
//     if (searchResultsContainer) {
//         searchResultsContainer.innerHTML = ''; // Clear previous search results
    
//         // Check if any projects found
//         if (projects.length > 0) {
//             // Iterate through each project and create a link for each
//             projects.forEach(project => {
//                 const link = document.createElement('a');
//                 link.href = `/managementenvironment/display?projectId=${project.project_id}`;
...
//       fetch(`/managementenvironment/display_project?projectId=${projectId}`)
//         .then(response => {
//           if (!response.ok) {
//             throw new Error('Network response was not ok');
//           }
...
//       fetch(`/managementenvironment/display_documentation?projectId=${projectId}`)
//         .then(response => {
//           if (!response.ok) {
//             throw new Error('Network response was not ok');
//           }
...
//       fetch(`/managementenvironment/display_report?projectId=${projectId}`)
//         .then(response => {
//           if (!response.ok) {
//             throw new Error('Network response was not ok');
//           }
...
//             const listItem = document.createElement('li');
//             const link = document.createElement('a');
//             link.href = `/managementenvironment/get-report/${report}`;
...
//     fetch(`/managementenvironment/display_presentation?projectId=${projectId}`)
//       .then(response => {
//         if (!response.ok) {
//           throw new Error('Network response was not ok');
//         }
...
//           const listItem = document.createElement('li');
//           const link = document.createElement('a');
//           link.href = `/managementenvironment/get-presentation/${presentation}`;
...
//     fetch(`/managementenvironment/display_other?projectId=${projectId}`)
//       .then(response => {
//         if (!response.ok) {
//           throw new Error('Network response was not ok');
//         }
...
//           const listItem = document.createElement('li');
//           const link = document.createElement('a');
//           link.href = `/managementenvironment/get-other/${other}`;
  ...
  if (searchResultsContainer) {
      ...
      if (data.files && data.files.length > 0) {
          ...
          data.files.forEach(file => {
              const link = document.createElement('a');
              link.href = `/managementenvironment/get-image/${file.filename}`;
