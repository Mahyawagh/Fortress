...
//     fetch('/managementsearch/project_list')
//     .then(response => {
//         if (!response.ok) {
...
//   fetch(`/managementsearch/search?searchInput=${searchInput}`)
//   .then(response => {
//       if (!response.ok) {
//           throw new Error('Network response was not ok');
//       }
...
//                 link.href = `/managementsearch/display?projectId=${project.project_id}`;
...
//                 const link = document.createElement('a');
//                 link.href = `/managementsearch/get-image/${file.filename}`;
...
//     fetch(`/managementsearch/display_project?projectId=${projectId}`)
//       .then(response => {
//         if (!response.ok) {
//           throw new Error('Network response was not ok');
//         }
...
//     fetch(`/managementsearch/display_documentation?projectId=${projectId}`)
//       .then(response => {
//         if (!response.ok) {
//           throw new Error('Network response was not ok');
//         }
...
//     fetch(`/managementsearch/display_report?projectId=${projectId}`)
//       .then(response => {
//         if (!response.ok) {
//           throw new Error('Network response was not ok');
//         }
...
//           const listItem = document.createElement('li');
//           const link = document.createElement('a');
//           link.href = `/managementsearch/get-report/${report}`;
...
//   fetch(`/managementsearch/display_presentation?projectId=${projectId}`)
//     .then(response => {
//       if (!response.ok) {
//         throw new Error('Network response was not ok');
//       }
...
//         const listItem = document.createElement('li');
//         const link = document.createElement('a');
//         link.href = `/managementsearch/get-presentation/${presentation}`;
...
//   fetch(`/managementsearch/display_other?projectId=${projectId}`)
//     .then(response => {
//       if (!response.ok) {
//         throw new Error('Network response was not ok');
//       }
...
//         const listItem = document.createElement('li');
//         const link = document.createElement('a');
//         link.href = `/managementsearch/get-other/${other}`;
