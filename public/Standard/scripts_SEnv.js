...
function searchProject() {
    ...
    fetch(`/StandEnv/search?searchInput=${searchInput}`)
    .then(response => {
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
    ...
    .then(data => {
        const projectUrl = `/StandEnv/display?refId=${data.refId}`;
...
function viewDocumentation(refId) {
    fetch(`/StandEnv/display_documentation?refId=${refId}`)
      .then(response => {
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
      ...
      .then(data => {
        ...
        documentation.forEach(doc => {
          ...
          link.href = `/StandEnv/get-documentation/${doc}`;
