...
function searchProject() {
    ...
    fetch(`/StandInd/search?searchInput=${searchInput}`)
    .then(response => {
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
    ...
    .then(data => {
        const projectUrl = `/StandInd/display?refId=${data.refId}`;
...
function viewDocumentation(refId) {
    fetch(`/StandInd/display_documentation?refId=${refId}`)
      .then(response => {
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
      ...
      .then(data => {
        ...
        documentation.forEach(doc => {
          ...
          link.href = `/StandInd/get-documentation/${doc}`;
