...
function searchProject() {
    ...
    fetch(`/StandTour/search?searchInput=${searchInput}`)
    .then(response => {
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
    ...
    .then(data => {
        const projectUrl = `/StandTour/display?refId=${data.refId}`;
...
function viewDocumentation(refId) {
    fetch(`/StandTour/display_documentation?refId=${refId}`)
      .then(response => {
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
      ...
      .then(data => {
        ...
        documentation.forEach(doc => {
          ...
          link.href = `/StandTour/get-documentation/${doc}`;
