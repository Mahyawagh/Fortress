...
function searchProject() {
  ...
  fetch(`/tourism/search?searchInput=${searchInput}`)
  .then(response => {
      if (!response.ok) {
          throw new Error('Network response was not ok');
      }
  ...
  .then(data => {
      const projectUrl = `/tourism/display?projectId=${data.projectId}`;
...
function viewPhotographs(projectId) {
  fetch(`/tourism/display_project?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
...
function viewDocumentation(projectId) {
  fetch(`/tourism/display_documentation?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      documentation.forEach(doc => {
        ...
        link.href = `/tourism/get-documentation/${doc}`;
...
function viewReport(projectId) {
  fetch(`/tourism/display_report?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      report.forEach(report => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/tourism/get-report/${report}`;
...
function viewPresentation(projectId) {
  fetch(`/tourism/display_presentation?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      presentation.forEach(presentation => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/tourism/get-presentation/${presentation}`;
...
function viewOther(projectId) {
  fetch(`/tourism/display_other?projectId=${projectId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
    ...
    .then(data => {
      ...
      other.forEach(other => {
        const listItem = document.createElement('li');
        const link = document.createElement('a');
        link.href = `/tourism/get-other/${other}`;
...
function deleteProject() {
  ...
  fetch(`/tourism/delete?searchInput=${searchInput}`)
      .then(response => {
          if (!response.ok) {
              throw new Error('Network response was not ok');
          }
